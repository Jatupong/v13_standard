...
class invoice_discount(models.Model):
    ...
    discount_view = fields.Selection([('After Tax', 'After Tax'), ('Before Tax', 'Before Tax')], default=False, string='Discount Type',
                                     states={'draft': [('readonly', False)]},
                                     help='Choose If After or Before applying Taxes type of the Discount')

    discount_type = fields.Selection([('Fixed', 'Fixed'), ('Percentage', 'Percentage')], default=False, string='Discount Method',
                                     states={'draft': [('readonly', False)]},
