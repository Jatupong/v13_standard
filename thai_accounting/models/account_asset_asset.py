...
class account_asset_asset(models.Model):
    ...
    def _get_reference_code(self,category_id):
        ...
        reference_code2 = self.env['ir.sequence'].next_by_code(reference_code1)
    ...
    def validate(self):
        if not (self.code and self.barcode):
            ...
            self.barcode = self._generate_ean13_value(self.code)
        ...
        #ถ้าไม่ใช้รายการสุดท่าย
            ...
            if self.method == 'linear':
                ...
                if self.prorata:
                    ...
                    amount_per_year = (self.asset_purchase_price - self.salvage_value) * ((float(12) / float(self.category_id.method_number)))
                   ...
                   #print "amount per day"
                    ...
                    if sequence == 1:
                        ...
                        # print "this is sequence in between"

                        #in case of disposal before end of the last depreciation then depreciation date will be real date to compute
                        # print "depreciation_date"
                        # print depreciation_date
                        # to recheck for sure the month_days is the last day of the month
                        month_days = calendar.monthrange(depreciation_date.year, depreciation_date.month)[1]
