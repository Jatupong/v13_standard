...
class purchase_order(models.Model):
    ...
    def action_view_invoice(self):
        ...
        res['context']['apply_discount'] = self.apply_discount
        res['context']['default_discount_account'] = self.discount_account.id
        res['context']['default_discount_type_id'] = self.discount_type_id.id
        res['context']['default_discount_value'] = self.discount_value
        res['context']['default_amount_after_discount'] = self.amount_after_discount
